...
<head>
        ...
        <link href="/admin/assets/vendor/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.css" rel="stylesheet" type="text/css" />
                ...
                <div class="container-fluid detached-nav">
                    ...
                    <div class="logo-topbar">
                        ...
                        <a href="index-2.html" class="logo-light">
                            <span class="logo-lg">
                                <img src="/admin/assets/images/logo.png" alt="logo" height="22">
                            </span>
                            <span class="logo-sm">
                                <img src="/admin/assets/images/logo-sm.png" alt="small logo" height="22">
                            </span>
                        </a>
                        ...
                        <a href="index-2.html" class="logo-dark">
                            <span class="logo-lg">
                                <img src="/admin/assets/images/logo-dark.png" alt="dark logo" height="22">
                            </span>
                            <span class="logo-sm">
                                <img src="/admin/assets/images/logo-dark-sm.png" alt="small logo" height="22">
                            </span>
                        </a>
                    </div>
                            ...
                            <ul class="navbar-nav">
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-dashboards">
                                        ...
                                        <a href="index-2.html" class="dropdown-item">Ecommerce</a>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            ?>
                                            <a href="<?=site_url() . '/cache/contacts/' . $contact?>" target="_blank"><?=$contact?></a><br/>
                                            <?php
                                            }
                                            ?>
                                            <h2>Order</h2>
                                            <table class="table table-centered table-nowrap table-hover mb-0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h5 class="font-14 my-1 fw-normal"><?= $order['first_name'] . ' ' . $order['last_name']?></h5>
                                                            <span class="text-muted font-13">07 April 2018</span>
                                                        </td>
                                                        <td>
                                                            <h5 class="font-14 my-1 fw-normal"><?=$order['ip']?></h5>
                                                            <span class="text-muted font-13">Price</span>
                                                        </td>
                                                        <td>
                                                            <h5 class="font-14 my-1 fw-normal"><?=$order['status']?></h5>
                                                            <span class="text-muted font-13">Quantity</span>
                                                        </td>
                                                        <td>
                                                            <h5 class="font-14 my-1 fw-normal"><?=$order['payment_status']?></h5>
